        ...
        <>
            <aside className="aside">
                <div className="aside-logo">
                    <div className="aside-logo-dot" title="MeshTalk" />
                </div>
                ...
                <nav className="aside_settings">
                    <NavLink to="/chat" title="Chat">
                        ...
                        <span className="aside-label">Chat</span>
                    ...
                    <NavLink to="/meetings" title="Meetings">
                        ...
                        <span className="aside-label">Meet</span>
                    </NavLink>
                    ...
                    <NavLink to="/notes" title="Notes">
                        ...
                        <span className="aside-label">Pad</span>
                    </NavLink>

                    <NavLink to="/network" title="How it Works">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <circle cx="12" cy="12" r="10"/>
                            <line x1="12" y1="8" x2="12" y2="12"/>
                            <line x1="12" y1="16" x2="12.01" y2="16"/>
                        </svg>
                        <span className="aside-label">How</span>
                    </NavLink>
                    ...
                    <NavLink to="/settings" title="Settings">
                        ...
                        <span className="aside-label">Config</span>
                    </NavLink>

                    <button className="profile-btn" onClick={() => setShowProfile(true)} title="Profile">
                        <UserAvatar name={localUser?.username} size={30} avatarUrl={localUser?.avatar_path} />
                        <span className="aside-label">You</span>
                    </button>
                </nav>
