...
// MeshTalk - P2P Desktop Messaging Application
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            if let Err(e) = tray::init_tray(&handle) {
                ...
                println!("[MeshTalk] Warning: failed to initialize tray: {}", e);
            }
            ...
            if let Some(window) = app.get_webview_window("main") {
                ...
                println!("[MeshTalk] Warning: main window not available during setup; skipping close-handler registration");
            }

            // Log initialization
            println!("MeshTalk initialized successfully");
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_meshtalk_downloads_base,
